...
public class Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Address(java.lang.String street1, java.lang.String street2, java.lang.String city, java.lang.String state, java.lang.String pinCode, java.lang.String country) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: street1 = value$ != null ? value$.toString() : null; break;
    case 1: street2 = value$ != null ? value$.toString() : null; break;
    case 2: city = value$ != null ? value$.toString() : null; break;
    case 3: state = value$ != null ? value$.toString() : null; break;
    case 4: pinCode = value$ != null ? value$.toString() : null; break;
   ...
   */
  public static model.schema.Address.Builder newBuilder() {
    return new model.schema.Address.Builder();
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static model.schema.Address.Builder newBuilder(model.schema.Address.Builder other) {
    if (other == null) {
      return new model.schema.Address.Builder();
    } else {
      return new model.schema.Address.Builder(other);
    }
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static model.schema.Address.Builder newBuilder(model.schema.Address other) {
    if (other == null) {
      return new model.schema.Address.Builder();
    } else {
      return new model.schema.Address.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Address>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.schema.Address.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.street1)) {
        this.street1 = data().deepCopy(fields()[0].schema(), other.street1);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (isValidValue(fields()[1], other.street2)) {
        this.street2 = data().deepCopy(fields()[1].schema(), other.street2);
      ...
      if (isValidValue(fields()[4], other.pinCode)) {
        this.pinCode = data().deepCopy(fields()[4].schema(), other.pinCode);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.schema.Address other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.street1)) {
        this.street1 = data().deepCopy(fields()[0].schema(), other.street1);
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setStreet1(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearStreet1() {
      street1 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setStreet2(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearStreet2() {
      street2 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setState(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setPinCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearPinCode() {
      pinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder setCountry(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.schema.Address.Builder clearCountry() {
      country = null;
    ...
    public Address build() {
      try {
        ...
        record.street1 = fieldSetFlags()[0] ? this.street1 : (java.lang.String) defaultValue(fields()[0]);
        record.street2 = fieldSetFlags()[1] ? this.street2 : (java.lang.String) defaultValue(fields()[1]);
        ...
        record.pinCode = fieldSetFlags()[4] ? this.pinCode : (java.lang.String) defaultValue(fields()[4]);
